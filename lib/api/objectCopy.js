...
function objectCopy(authInfo, request, sourceBucket,
    ...
    log.info('processing request', { method: 'objectCopy', sourceBucket,
    ...
    return async.waterfall([
        ...
        function storeNewMetadata(storeMetadataParams, destDataGetInfoArr,
            ...
            async.waterfall([
                callback => services.versioningPreprocessing({}, destBucketMD,
                    destBucketName, destObjMD, destObjectKey, log, callback),
                (options, callback) => {
        ...
        log.info('origin headers', { orign: request.headers });
        const corsHeaders = collectCorsHeaders(request.headers.origin,
            request.method, destBucketMD);
        log.info('cors headers', { cors: corsHeaders });
        ...
        // if (sourceVersionId) {
        //     additionalHeaders['x-amz-copy-source-version-id'] = sourceVersionId;
        // }
        // if (res) {
        //     additionalHeaders['x-amz-version-id'] = res.versionId;
        // }
