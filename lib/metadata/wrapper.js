...
const metadata = {
    ...
    putObjectMD: (bucketName, objName, objVal, params, log, cb) => {
        ...
        client.putObject(bucketName, objName, objVal, params, log, cb);
    },
